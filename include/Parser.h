...
private:
    ...
    std::unique_ptr<AssigmentExpressionList> parseARGUMENT_EXPRESSION_LIST();
    std::unique_ptr<AssigmentExpression> parseASSIGNMENT_EXPRESSION();
    std::unique_ptr<ASTNode> parseASSIGNMENT_EXPRESSION_FAC();
    std::unique_ptr<AssigmentExpression> parseASSIGNMENT_EXPRESSION_OPT_FAC();
    std::unique_ptr<AssigmentOperator> parseASSIGNMENT_OPERATOR();
    ...
    std::unique_ptr<Expr> parseEXPRESSION_STATEMENT();
    std::unique_ptr<ForInitStatement> parseFOR_INIT_STATEMENT();
    std::unique_ptr<Expr> parseFOR_OPTIONAL_EXPRESSION();
    ...
    std::unique_ptr<IdentifierList> parseIDENTIFIER_LIST();
    ...
    std::unique_ptr<ParameterDeclaration> parsePARAMETER_DECLARATION();
    std::unique_ptr<ParameterDeclarationList> parsePARAMETER_LIST();
    std::unique_ptr<FunctionDirectDeclarator> parsePARAMETER_LIST_OPT_FAC();
    std::unique_ptr<ASTNode> parsePARAMETER_LIST_PRIME();
    std::unique_ptr<Declarator> parsePARAM_DECL_FAC();
    bool parsePOINTER();
    std::unique_ptr<AssigmentExpressionList> parsePOSTFIX_ARGUMENTS();
    std::unique_ptr<PostfixExpressions> parsePOSTFIX_EXPRESSION();
    ...
    std::unique_ptr<UnaryExpr> parseUNARY_EXPRESSION();
};
